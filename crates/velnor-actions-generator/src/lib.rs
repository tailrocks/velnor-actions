...
pub fn scaffold_consumer(
    ...
    let files = [
        ...
        (
            "mise.toml",
            scaffold_mise_file(metadata, class),
        ),
        (
            "mise.lock",
            "# @generated by mise lock\n\nlockfile_version = 1\n\n[[tools.\"github:jdx/mise\"]]\nversion = \"2026.7.12\"\nbackend = \"github:jdx/mise\"\nspecifiers = [\"2026.7.12\"]\n"
                .to_owned(),
        ),
    ];
    let mut written = Vec::new();
...
fn scaffold_mise_file(metadata: &model::CensusMetadata, class: RepositoryClass) -> String {
